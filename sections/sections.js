Vvveb.Sections.add("hero/hero-1", {
  ...
  <div class="container">
    <div class="heading">
      ...
      <div class="btns">
        ...
        <div class="nav-item dropdown">
          <a class="btn btn-outline-primary nav-link dropdown-toggle" href="#" role="button">Demo <b>›</b>
          </a>
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            <a class="dropdown-item" target="_blank" href="#">Link 1</a>
            <a class="dropdown-item" target="_blank" href="#">Link 2</a>
            <a class="dropdown-item" target="_blank" href="#">Link 3</a>
          </div>
        </div>
      </div>
    ...
    <div class="frame mx-auto">
      <video loading="lazy" src="video/intro.mp4" muted loop controls data-image-hint="width=1920" poster="https://www.vvveb.com/img/dark-theme.png"></video>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-center justify-content-between">
      <div class="col-lg-6 mb-5 ms-5" data-aos="fade-up" data-aos-delay="0">
        ...
        <p class="subheading mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim. </p>
        <p>
          ...
          <a href="#" class="btn text-white">Secondary Button</a>
        </p>
      </div>
  ...
  <div class="container">
    <div class="row align-items-center justify-content-center text-center">
      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
        <h1 class="heading mb-3 display-4">Lorem ipsum dolor sit amet.</h1>
  ...
  <div class="container" style="z-index:2">
    <div class="row align-items-center d-flex justify-content-between">
      <div class="col-12 col-md-6 pb-5 order-2 order-sm-2 ">
        <h1 class="fw-bold mb-3 mt-5 display-3">Lorem ipsum dolor sit amet.</h1>
        <p class="lead">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim.
        </p>
...
Vvveb.Sections.add("features/features-1", {
    ...
    html: `<section class="features-1 bg-alternate">
  <div class="container">
    <div class="row wrap">
      <div class="col-md-7 align-self-center">
        <div class="max-box">
          <span class="badge  bg-success rounded-pill px-3 opacity-50">badge</span>
          <h3 class="mt-2">Lorem ipsum dolor sit amet.</h3>
          <div class="mt-4">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ullamcorper, dui vitae ullamcorper rutrum, quam orci cursus ex, consectetur interdum mauris purus ut ligula.</p>

            <p>Cras felis nunc, aliquet ut efficitur a, feugiat vel elit. Donec tortor turpis, ultricies vel massa eu, efficitur feugiat est. Vivamus non viverra libero. </p>

            <p>Aliquam tempor porttitor velit a consectetur. Sed rhoncus sagittis euismod. Etiam vitae nunc eu lectus feugiat vulputate. Etiam ut luctus eros.</p>
          </div>
    ...
    html: `<section class="features-2 py-5 bg-alternate">

  <div class="row no-gutters">
    <div class="col-lg-6">
      <img alt="image" src="img/illustrations.co/day68-happy-cat.svg" data-image-hint="width=1920" loading="lazy" class="img-fluid">
    </div>

    <div class="col-lg-6 bg-primary bg-gradient text-white d-flex">

      <div class="text-box align-self-center">
        <h3 class="text-white mb-3">Lorem ipsum dolor sit amet.</h3>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim.
        </p>
        <ul class="list-block">
          <li class="my-2">
            <span>Cras felis nunc, aliquet ut efficitur a, feugiat vel elit.</span>
          </li>
          <li class="my-2">
            <span>Aliquam tempor porttitor velit a consectetur. Sed rhoncus sagittis euismod.</span>
          </li>
          <li class="my-2">
            <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim. </span>
          </li>
        </ul>
    ...
    html: `<section class="features-3 py-5 bg-alternate">
  <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 mb-4">
            <div class="d-flex align-items-center">
              ...
              <div class="p-4">
                <h6 class="text-muted">
                  <a href="#" class="linking">Lorem ipsum dolor sit amet.</a>
                </h6>
                <p class="mt-3">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim.
                </p>
    ...
    html: `<section class="features-4 py-5 bg-primary bg-gradient text-white">
  ...
  <div class="container">
    ...
    <div class="row text-center justify-content-sm-center no-gutters">
      <div class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-3 m-auto">
        <div>
          ...
          <p class="mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim. </p>
          <p class="mt-4">
    ...
    html: `<section class="features-5 py-5 bg-alternate">
  ...
  <div class="container">
    ...
    html: `<section class="features-6 py-5 bg-alternate">
  <div class="container">
    ...
    html: `<section class="features-7 py-5 bg-alternate">
  <div class="container">
    <div class="row text-center">
      <div class="col-12">
        <h2>Lorem ipsum dolor sit amet.</h2>
    ...
    <div class="row text-center justify-content-center">
      <div class="col-12 col-md-6 col-lg-3">
        <div>
          <img alt="" loading="lazy" src="img/illustrations.co/109-map-location.svg" data-image-hint="width=512">
          <h3>Cras felis nunc.</h3>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div>
          <img loading="lazy" src="img/illustrations.co/107-healthy.svg" data-image-hint="width=512">
          <h3>Cras felis nunc.</h3>
          <p class="lead text-muted mt-4">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim.
          </p>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div>
          <img loading="lazy" src="img/illustrations.co/104-dumbbell.svg" data-image-hint="width=512">
          <h3>Cras felis nunc.</h3>
          <p class="lead text-muted mt-4">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim.
          </p>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div>
          <img loading="lazy" src="img/illustrations.co/126-namaste-no-hand-shake.svg" data-image-hint="width=512">
          <h3>Cras felis nunc.</h3>
          <p class="lead text-muted mt-4">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim.
          </p>
    ...
    html: `<section class="features-8 py-5 bg-alternate">
  <div class="container">
    <div class="row text-center">
      <div class="col-12">
        <h2>Lorem ipsum dolor sit amet.</h2>
    ...
    <div class="row text-start mt-5">
      <div class="col-12 col-md-4">
        <div class="row">
          <div class="col-3">
            <img alt="" loading="lazy" src="img/illustrations.co/109-map-location.svg" data-image-hint="width=364">
          </div>
          <div class="col-9">
      ...
      <div class="col-12 col-md-4 pt-3 pt-sm-4">
        <div class="row">
          <div class="col-3">
            <img alt="" loading="lazy" src="img/illustrations.co/107-healthy.svg" data-image-hint="width=364">
          </div>
          <div class="col-9">
            <h4>Cras felis nunc.</h4>
            <p class="lead text-muted mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim. </p>
      ...
      <div class="col-12 col-md-4 pt-3 pt-sm-4">
        <div class="row">
          <div class="col-3">
            <img alt="" loading="lazy" src="img/illustrations.co/104-dumbbell.svg" data-image-hint="width=364">
          </div>
          <div class="col-9">
            <h4>Cras felis nunc.</h4>
            <p class="lead text-muted mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim. </p>
    ...
    <div class="row text-start pt-3 pt-sm-4 pt-md-5">
      <div class="col-12 col-md-4">
        <div class="row">
          <div class="col-3">
            <img alt="" loading="lazy" src="img/illustrations.co/126-namaste-no-hand-shake.svg" data-image-hint="width=364">
          </div>
          <div class="col-9">
            <h4>Cras felis nunc.</h4>
            <p class="lead text-muted mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim. </p>
    ...
    html: `<section class="features-9 py-5 bg-alternate">
  <div class="container">
    <div class="row text-center">
      <div class="col-12">
        <h2>Lorem ipsum dolor sit amet.</h2>
    ...
    html: `<section class="features-10 py-5 bg-alternate">
  <div class="container">
    ...
    html: `<section class="features-11 py-5 bg-alternate">
  <div class="container">
    <div class="row text-center">
...
});Vvveb.Sections.add("base/text-column", {
    name: "Text column",
    image: Vvveb.themeBaseUrl + "/screenshots/sections/base/text-column-thumb.jpeg",
    html: `<section class="py-4">
  <div class="container">
    <div class="row">
      <div class="col col-12 col-lg-6 offset-lg-3 col-md-8 offset-md-2">
        <h1>Text title</h1>

        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin venenatis vestibulum tempus. Donec tincidunt mi vel rhoncus mollis. Mauris rhoncus enim ac rhoncus malesuada. Vestibulum in laoreet ante. Vivamus ornare condimentum dolor in tempus. Integer sit amet urna vitae velit blandit fermentum non ut turpis. Donec egestas felis et libero efficitur sollicitudin. Praesent dapibus dapibus est. Praesent nunc leo, molestie in nibh vel, molestie commodo lectus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Pellentesque blandit dapibus aliquam. Nullam accumsan commodo suscipit. Nulla dui augue, sodales sed massa vel, tempor ornare eros. Quisque turpis sem, finibus id euismod at, cursus sed ex. Curabitur at nisi et justo mattis consectetur.
        </p>

        <p>
          Mauris tempor, mauris quis cursus volutpat, nibh est dignissim mauris, vel sollicitudin enim felis sed felis. Fusce tristique, risus et placerat egestas, ligula neque tempor neque, at faucibus tellus turpis vel eros. Praesent auctor tortor interdum, dictum leo eget, auctor sem. Proin accumsan, metus a facilisis mollis, odio felis pharetra nibh, nec accumsan felis velit quis lorem. Quisque interdum commodo eleifend. Cras semper varius odio, vel viverra velit consectetur eu. Ut et turpis tincidunt, suscipit sem id, elementum tellus. Vivamus eget ex sollicitudin, tempus urna vitae, pretium mi. Integer a purus ex. Nullam malesuada arcu nec magna malesuada tristique. Donec condimentum interdum sapien at imperdiet. Nunc id tortor lectus. Phasellus et dui erat.
        </p>
      </div>
    </div>
  </div>
	...
	Vvveb.SectionsGroup["Base"] = ["base/1-column","base/2-columns","base/3-columns","base/4-columns","base/6-columns","base/8-columns","base/12-columns","base/blank","base/text-column"];
Vvveb.Sections.add("contact-form/contact-form-1", {
    ...
    html: `<section class="contact-form-9">
  ...
  <div class="container">
    ...
    html: `<section class="contact-form-12 py-0">
  ...
  <div class="container-fluid p-0">
    ...
    html: `<section class="contact-form-13">
  <div class="container">
    <div class="row text-center justify-content-center">
      <div class="col-12 col-md-8 col-lg-7">
        <h1>Contact Us</h1>
    ...
    html: `<section class="contact-form-2 container-fluid px-5 my-5">
  <div class="row justify-content-center">
    <div class="col-xl-10">
    ...
    html: `<section class="contact-form-6">
  ...
  <div class="container">
    <div class="row my-5">
      <div class="col-12 col-md-6 col-lg-5">
        ...
        <p class="lead">
          Aliquam tempor porttitor velit a consectetur. Sed rhoncus sagittis euismod.
        </p>
    ...
    html: `<section class="contact-form-8">
  <div class="container">
    <div class="row text-center justify-content-center">
      <div class="col-12 col-md-8 col-lg-7">
        <h1>Contact Us</h1>
...
Vvveb.Sections.add("posts/posts-1", {
  ...
  <div class="container">
    ...
    html: `<section class="posts-3 py-5">
  <div class="container">
...
Vvveb.Sections.add("pricing-table/pricing-table-3", {
    ...
    html: `<section class="pricing-table-3">
  <div class="container">
...
Vvveb.Sections.add("showcase/showcase-1", {
    ...
    html: `<section class="d-flex showcase-1">
  <div class="container">
    <div class="row align-items-center w-100">
      ...
      <div class="col-md-6 col-sm-12 col-img">
        <img class="img-fluid" data-image-hint="width=768" loading="lazy" src="img/illustrations.co/126-namaste-no-hand-shake.svg" alt="">
      </div>
    </div>
  </div>
</section>`
    ...
    html: `<section class="d-flex showcase-2">
  <div class="container">
    <div class="row align-items-center w-100">
      <div class="col-md-6 col-sm-12 col-img">
        <img class="img-fluid" data-image-hint="width=768" src="img/illustrations.co/107-healthy.svg" alt="">
      </div>
      <div class="col-md-6 col-sm-12">
        <h3>Lorem ipsum dolor sit amet.</h3>
        <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus in lectus ut dignissim. </p>
  ...
  <div class="container">
    ...
    html: `<section class="showcase-10">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-7 mx-auto" data-aos="fade-up" data-aos-delay="0">
        <div class="feature">
  ...
  <div class="container">
    ...
    html: `<section class="showcase-12"">
  <div class=" container">
  <div class="row g-1 justify-content-center">
    <div class="col-12 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="0">
      <div class="feature">
...
Vvveb.Sections.add("team/team-1", {
  ...
  <div class="container">
    ...
    html: `<section class="py-5 team-2">
  <div class="container">
    <div class="row justify-content-center mb-4">
      <div class="col-md-7 text-center">
...
Vvveb.Sections.add("testimonials/testimonials-1", {
    ...
    html: `<section class="testimonials-1 bg-alternate">
  <div class="container">
    <div class="row justify-content-center mb-4">
      <div class="col-md-7 text-center">
